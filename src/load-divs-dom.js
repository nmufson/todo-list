...
export const loadTodoFuncContainer = (projectArray,projectsObject) => {
    const makeDiv = (todo) => {
    ...
    const loadTodoItemOuter = () => {
        ...
        addNewTodoFuncContainer(projectArray,projectsObject).loadAddNewTodoDiv();
    ...
    return { makeDiv, loadTodoItemOuter};
}